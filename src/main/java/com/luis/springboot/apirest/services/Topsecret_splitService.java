...
@Service
public class Topsecret_splitService {
	...
	public SatelliteModel guardarSatellite(SatelliteModel satelliteModel) {
		return satelliteRepository.save(satelliteModel);
	}
	
	public ResponseModel findCordinate(SatelliteModel satellite1,SatelliteModel satellite2,SatelliteModel satellite3) {
